...
public:
	 ...
	 * the UI thread that owns the window, so this only queues webview
	 * teardown on the UI thread and the pump releases the webview and
	 * destroys it. Safe to call after the window has already gone.
	 */
